...
def desk_print(dict, hand, desk):
    for i in range(1, 9):
        if i not in dict:
            dict[i]=' '
    print('=====================================================')
    print('玩家1:%-15s' % dict[1], '筹码：')
    print('玩家2:%-15s' % dict[2], '筹码：')
    print('玩家3:%-15s' % dict[3], '筹码：')
    print('玩家4:%-15s' % dict[4], '筹码：')
    print('玩家5:%-15s' % dict[5], '筹码：')
    print('玩家6:%-15s' % dict[6], '筹码：')
    print('玩家7:%-15s' % dict[7], '筹码：')
    print('玩家8:%-15s' % dict[8], '筹码：')
